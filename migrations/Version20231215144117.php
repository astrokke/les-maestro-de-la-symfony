 ...
 */
final class Version20231215144117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_24CC0DF267B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commande ADD livraison_id INT DEFAULT NULL, ADD paiement_id INT DEFAULT NULL, ADD etat_id INT DEFAULT NULL, ADD est_livré_id INT NOT NULL, ADD est_facture_id INT NOT NULL, ADD users_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_6EEAA67DF2EFD822 ON commande (est_livré_id)');
        $this->addSql('CREATE INDEX IDX_6EEAA67D8E569DDE ON commande (est_facture_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6EEAA67DF2EFD822 ON commande');
        $this->addSql('DROP INDEX IDX_6EEAA67D8E569DDE ON commande');
        $this->addSql('DROP INDEX IDX_6EEAA67D67B3B43D ON commande');
        $this->addSql('ALTER TABLE commande DROP livraison_id, DROP paiement_id, DROP etat_id, DROP est_livré_id, DROP est_facture_id, DROP users_id');
    }
}
