 ...
 */
final class Version20231218155626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photos ADD categorie_id INT DEFAULT NULL, ADD url_photo VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photos DROP categorie_id, DROP url_photo');
